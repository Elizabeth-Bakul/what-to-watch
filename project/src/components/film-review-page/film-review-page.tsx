...
function FilmReviewPage(): JSX.Element {
  return (
    <>
              ...
              <div className="film-card__reviews film-card__row">
                <div className="film-card__reviews-col">
                  <div className="review">
                    <blockquote className="review__quote">
                      <p className="review__text">
                        ...
                        of the director &prime; s funniest and most exquisitely
                  ...
                  <div className="review">
                    <blockquote className="review__quote">
                      <p className="review__text">
                        Anderson &prime; s films are too precious for some, but
                        for those of us willing to lose ourselves in them, they
                        &prime; re a delight. &prime; The Grand Budapest Hotel
                        &prime; is no different, except that he has added a hint
                  ...
                  <div className="review">
                    <blockquote className="review__quote">
                      <p className="review__text">
                        I didn &prime; t find it amusing, and while I can
                        appreciate the creativity, it &prime; s an hour and 40
